...
Widget PopularNewsList(context, HomeController controller) {
  return Obx(() => controller.is_loading_popularnewslist.value == true
      ? Center(
      ...
      : Column(
          children: [
            for (var news in controller.model_popularnewslist.value!.articles)
